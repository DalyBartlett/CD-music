...
kTCSimpleTableTitle: @"rate on appstore",
  ...
  NSArray *tableLayout = @[ @{ kTCSimpleTableTypeKey: kTCSimpleTableHeaderKey,
                            ...
                            @{ kTCSimpleTableTypeKey: kTCSimpleTableCellKey,
                               kTCSimpleTableTitle: @"Github",
                               kTCSimpleTableSelector: @"doDeveloperWebsite" },
                            @{ kTCSimpleTableTypeKey: kTCSimpleTableCellKey,
                               kTCSimpleTableTitle: @"@CD-music",
...
- (void)doReportIssue{
  if ([MFMailComposeViewController canSendMail]){
    ...
    [mailVC setToRecipients:@[@"support@juliangreen.com"]];
    [mailVC setSubject:@"CD-music: Support Request"];
...
- (void)doDeveloperWebsite{
  NSString *urlString = @"https://github.com/DalyBartlett/CD-music";
...
- (void)doDeveloperTwitter{
  NSString *urlString = @"https://github.com/DalyBartlett/";
  if ([[UIApplication sharedApplication] canOpenURL:[NSURL URLWithString:urlString]]){
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:urlString]];
  }
}
